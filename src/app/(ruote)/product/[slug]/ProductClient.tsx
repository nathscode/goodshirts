...
import { abbreviateMetrics } from "@/lib/utils";
import { ChevronDownIcon, Star, StarIcon } from "lucide-react";
		...
		<>
			<div className="flex flex-wrap justify-center md:justify-start w-full">
				<div className="w-full sm:w-1/2 md:px-3">
					<DetailProductImage image={"/images/clothes/2.jpg"} />
				</div>
			...
			<div className="flex flex-col justify-center items-center w-full mt-10">
				...
				<Carousel title="Recommended" imageLength={products.length}>
				...
				<div className="flex flex-col justify-start w-full">
					<div className="flex justify-start">
						<span className="inline-flex justify-center items-center">
							...
							<span className="text-lg md:text-2xl font-bold ms-2">4.5</span>
						</span>
					</div>
